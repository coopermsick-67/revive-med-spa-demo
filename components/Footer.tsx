    ...
    <footer className="bg-gray-950 text-white/70 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Professional {category} services in {serviceArea}.
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <Link href="#contact" className="block hover-white transition-colors">Contact</Link>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
          ...
          <p>
            Website by{" "}
            <span className="text-white font-medium">Sick Web Studio</span>
          </p>
        </div>
      </div>
    </footer>
